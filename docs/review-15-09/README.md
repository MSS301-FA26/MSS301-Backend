# CinemaAI — Conceptual và Stitch ngày 15/09
...
- Web: `DÁN_LINK_STITCH_WEB_VÀO_ĐÂY`
- Mobile: `DÁN_LINK_STITCH_MOBILE_VÀO_ĐÂY`

Trước ngày review, mở hai link bằng cửa sổ ẩn danh để kiểm tra quyền truy cập.

## Phạm vi của lần review

- Conceptual target khi chuyển monolith hiện tại sang microservices.
- Data ownership, logical reference và transaction snapshot.
