package com.cinemaai.booking.exception;

import com.cinemaai.booking.dto.response.ErrorResponse;
import com.cinemaai.booking.dto.response.FieldErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleUnexpected(Exception exception, HttpServletRequest request) {
        ...
        return build(HttpStatus.INTERNAL_SERVER_ERROR, "Unexpected server error: " + exception.getMessage(), request);
    }
