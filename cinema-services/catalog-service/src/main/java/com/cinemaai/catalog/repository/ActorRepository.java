...
import com.cinemaai.catalog.repository.projection.ActorMovieCountProjection;
...
public interface ActorRepository extends JpaRepository<Actor, Long> {
    ...
    @Query("""
            ...
            where movieActor.movie.status <> com.cinemaai.catalog.enums.MovieStatus.INACTIVE
            group by actor
            order by lower(actor.name)
            """)
    ...
    @Query("""
            ...
            where actor.id = :actorId
              and movieActor.movie.status <> com.cinemaai.catalog.enums.MovieStatus.INACTIVE
            group by actor
            """)
